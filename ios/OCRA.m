...
+ (NSString *) generateOCRAForSuite:(NSString*) ocraSuite
    ...
    if([dataInput rangeOfString:@"s128" options:NSCaseInsensitiveSearch].location != NSNotFound) {
    ...
    if([dataInput rangeOfString:@"s256" options:NSCaseInsensitiveSearch].location != NSNotFound) {
    ...
    if([dataInput rangeOfString:@"s512" options:NSCaseInsensitiveSearch].location != NSNotFound) {
